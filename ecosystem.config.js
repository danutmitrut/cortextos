  ...
  apps: [
    {
      ...
      script: "/Users/danmitrut/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/danmitrut/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/danmitrut/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/danmitrut/cortextos",
        CTX_PROJECT_ROOT: "/Users/danmitrut/cortextos",
        CTX_ORG: process.env.CTX_ORG || "dm-brain-orchestra",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: "npm",
      args: "run dev",
      cwd: "/Users/danmitrut/cortextos/dashboard",
      env: {
